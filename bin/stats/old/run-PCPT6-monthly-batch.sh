...
do
        ...
        python3 leaderboard-txt-sqlite2-monthly.py ${start_date[$i]} ${end_date[$i]} PCPT6 small > log/lb_txt_PCPTOT_sm.log

        python3 leaderboard-txt-sqlite2-monthly.py ${start_date[$i]} ${end_date[$i]} PCPT6 large > log/lb_txt_PCPTOT_lrg.log
