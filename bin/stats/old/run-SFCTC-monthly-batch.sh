...
do
        ...
        python3 leaderboards-txt-sqlite2.py ${start_date[$i]} ${end_date[$i]} SFCTC small > log/lb_txt_SFCTC_sm.log

        python3 leaderboards-txt-sqlite2.py ${start_date[$i]} ${end_date[$i]} SFCTC large > log/lb_txt_SFCTC_lrg.log
