...
do
        ...
        python3 leaderboard-txt-sqlite2-monthly.py ${start_date[$i]} ${end_date[$i]} SFCWSPD_KF small > log/lb_txt_SFCWSPD_KF_sm.log

        python3 leaderboard-txt-sqlite2-monthly.py ${start_date[$i]} ${end_date[$i]} SFCWSPD_KF large > log/lb_txt_SFCWSPD_KF_lrg.log
