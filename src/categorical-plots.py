...
This script is for the weekly leadership board for categorical stats (precip & wind). to run as a batch see /bin/run-catplot-weekly.sh
requires input: start_date end_date domain e
"""
...
def make_leaderboard_sorted(var, var_name, var_unit, time_domain, time_label,POD,POFD,PSS, HSS, CSI, GSS,modelnames,modelcolors,edited_modelnames,skipped_modelnames,numofstations):     
    ...
    plt.tight_layout(pad = 10.0, w_pad=20)
    ...
    plt.savefig(save_folder + 'categorical/' + start_date[:-2] + '/' + input_domain + '_' + var + '_' + savetype + '_' + time_domain + '.png',bbox_inches='tight')
...
def make_leaderboard_unsorted(var, var_name, var_unit, time_domain):     
    ...
    fig, ((ax1, ax2, ax3), (ax4, ax5, ax6)) = plt.subplots(2, 3,figsize=(25,25),dpi=150)
    plt.tight_layout(pad = 10, w_pad=20)
    plt.subplots_adjust(top=0.9)
    ...
    plt.savefig(textfile_folder + start_date[:-2] + '/' + input_domain + '_' + var + '_' + savetype + '_unsorted_' + time_domain + '.png',bbox_inches='tight')
...
def make_leaderboard_gridsize(var, var_name, var_unit, time_domain):     
    ...
    fig, ((ax1, ax2, ax3), (ax4, ax5, ax6)) = plt.subplots(2, 3,figsize=(25,25),dpi=150)
    plt.tight_layout(h = 10, w_pad=20)
    plt.subplots_adjust(top=0.9)
    ...
    plt.savefig(textfile_folder + start_date[:-2] + '/' + input_domain + '_' + var + '_' + savetype + '_gridsize_'+time_domain+'.png',bbox_inches='tight')
