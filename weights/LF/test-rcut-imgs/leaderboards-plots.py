...
save_folder = '/home/verif/verif-post-process/weights/'
...
textfile_folder = '/home/verif/verif-post-process/weights/LF/output-rcut30/weights-seasonal/'
...
def make_leaderboard_sorted(var, var_name, var_unit, time_domain, time_label,MAE,RMSE,corr,modelnames,modelcolors):
    ...
    plt.savefig(save_folder  + input_domain + '_' + var + '_' + time_domain + '_rcut30.png',bbox_inches='tight')
   ...
   # sys.stdout = open(logfilepath, "w") #opens log file
    ...
    for var in variables: #loop through variables
        ...
        for time_domain in time_domains:
            ...
            print(MAE) 
            make_leaderboard_sorted(var, variable_names[var_i], variable_units[var_i], time_domain,time_label, MAE,RMSE,corr,modelnames,modelcolors)
