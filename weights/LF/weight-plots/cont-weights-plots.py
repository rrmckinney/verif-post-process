...
textfile_folder = '/home/verif/verif-post-process/weights/LF/output-rcut15/weights-seasonal/'
weight_type = 'rcut15'
###########################################################
### -------------------- INPUT ------------------------
###########################################################
...
def make_leaderboard_sorted(var, var_name, time_domain, time_label,MAE,RMSE,corr,modelnames,modelcolors):
    ...
    ax1.set_xlabel(var_name + " and MAE Weight",fontsize=20)
    ...
    ax2.set_xlabel(var_name + " and RMSE Weight",fontsize=20)
    ...
    ax3.set_xlabel(var_name + " and SRC Weight",fontsize=20)
