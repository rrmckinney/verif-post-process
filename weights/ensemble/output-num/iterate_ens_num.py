...
model_list = ['WRF4RDPS_g3','WRF4NAM_g4', 'WRF4NAM_g3','WRF4NAM_g2','WRF3GFSgc01_g2', 'WRF3ARPEGE_g2', 'WRF3ARPEGE_g3','WRF3NAM_g4', \
...
def main(args):
    ...
    for s in range(len(station_list)):
        ...
        for i in range(len(model_list)):
            names = model_list[0:i+2]
            ENS = fcst_all.loc[:,names]
            ...
            df = pd.concat([ENS_num,ENS_M,obs_df], axis=1)
            print(df)
            df.columns = ['ENS_num','ENS_M','Obs']
            ...
            '''
            fig, axs = plt.subplots(1, figsize=(50,10))
