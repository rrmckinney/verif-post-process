...
output_15 = '/home/verif/verif-post-process/weights/ensemble/src/output-rcut15/'
output_30 = '/home/verif/verif-post-process/weights/ensemble/src/output-rcut30/'
...
for v in variables:
    ...
    for s in stats:
        if s == "MAE":
            ...
            mae30 = pd.read_csv(output_30 + s + '_' + v +'_seasonal_LF_.txt',sep = "\s+|,")
            ...
            rmse30 = pd.read_csv(output_30 + s + '_' + v +'_seasonal_LF_.txt',sep = "\s+|,")
            ...
            spcorr30 = pd.read_csv(output_30 + s + '_' + v +'_seasonal_LF_.txt',sep = "\s+|,")
    ...
    labels = ['rcut: 15; rhalf:7', 'rcut: 30; rhalf: 16']
    plt.legend(lines, labels, loc='upper center',bbox_to_anchor=(0.5, -0.1), ncol=10)
    plt.savefig('ENS_W_vs_ENS_M_'+v+'_diffcuts', bbox_inches="tight")
