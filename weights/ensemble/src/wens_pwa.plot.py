...
output_file = '/home/verif/verif-post-process/weights/ensemble/src/output-pwa/'
...
for v in variables:
    ...
    for s in stats:
        if s == "MAE":
            mae = pd.read_csv(output_file + s + '_' +v + '_seasonal_PWA_MAE__NA.txt',sep = "\s+|,")
            ...
            rmse = pd.read_csv(output_file + s + '_' +v + '_seasonal_PWA_MAE__NA.txt',sep = "\s+|,")
            ...
            spcorr = pd.read_csv(output_file + s + '_' +v + '_seasonal_PWA_MAE__NA.txt',sep = "\s+|,")
